...
function load() {
    ...
    request.onload = function () {
        ...
        try {
            document.getElementById("name").setAttribute('Value', param["name"]);
            document.getElementById("baud").setAttribute('Value', param["baud"]);
            document.getElementById("soft_baud").setAttribute('Value', param["soft_baud"]);
            document.getElementById("ip_add").setAttribute('Value', param["ip"]);
            document.getElementById("ip_gw").setAttribute('Value', param["gw"]);
            document.getElementById("sm").setAttribute('Value', param["sm"]);
        }
        catch (err) {}
    };
    request.send(null);
